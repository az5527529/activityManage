...
public class ActivityController {
    ...
    public void saveOrUpdate(HttpServletRequest request,
        ...
        try{
            ...
            entity = this.activityService.saveOrUpdate(entity);
            result.put("activity",entity);
    ...
    @RequestMapping(value = "/loadAllActivity", method = RequestMethod.POST)
    public void loadAllActivity(HttpServletRequest request,
                         HttpServletResponse response) throws IOException {
        List<Activity> list = activityService.loadAllActivity();
