...
<body class="easyui-layout">
	...
	<div data-options="region:'west',title:'系统菜单',split:true"
		...
		<div id="menu" class="easyui-accordion" data-options="fit:true">
			<div title="数据统计">
				<ul>
					<li><a href="#" title="${ctx}/pages/system/showData.action">报名统计</a></li>
					<li><a href="#" title="${ctx}/pages/system/signupManage.action?status=3">已缴费列表</a></li>
					<li><a href="#" title="${ctx}/pages/system/signupManage.action?status=1">未缴费列表</a></li>
				</ul>
			</div>
			<div title="活动管理">
				<ul>
